...
<%@ page import="example.package.DatabaseConnector" %> 
<%
                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div class="text-center mb-5">
                            ...
                            <!-- <p class="lead fw-normal text-muted mb-0">Register your account</p> -->
                        </div>
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form id="registrationForm" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="username" type="text" placeholder="Select your Username" data-sb-validations="required" />
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="password" type="text" placeholder="Select your Password" data-sb-validations="required" />
                                        <label for="name">Password</label>
                                        <div class="invalid-feedback" data-sb-feedback="password:required">A password is required.</div>
                                    </div>
                                    <!-- DOB input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="date" id="dob" name="dob" data-sb-validations="required" />
                                        <label for="phone">Date of Birth</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="address" type="text" placeholder="Type your Address" data-sb-validations="required" />
